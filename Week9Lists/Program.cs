// Listid võimaldavad salvestada suuri hulki andmeid
// Võimaldab salvestada mitmesuguseid anmeid (täisarvud ja 'klassid')

// Kirjutame ostunimekirja-lugeja
...
static List<string> GetItemsFromUser()
{
    ...
    while (true)
    {
        ...
        if (userChoice == "add")
        {
            ...
            userList.Add(userItem); // userItem lisatakse myshoppingList-i
        }
        else
        {
